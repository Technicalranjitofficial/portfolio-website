  ...
  return (
    <div className="flex lg:flex justify-evenly lg:justify-evenly mt-6">
     ...
     <div className="flex flex-col ">
        <h1 className="font-bold text-4xl text-yellow-100 font-Montserrat">Hi there, I'm <span className="text-cyan-500">
        <Typewriter
      ...
      <div className="mt-3">
        <img className="h-auto w-72 max-w-sm mx-auto animate-pulse"  src="https://creativedesignsguru.com/demo/astro-boilerplate/assets/images/avatar.svg" alt="img" />
      </div>
